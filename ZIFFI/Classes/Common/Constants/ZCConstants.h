...
UIKIT_EXTERN CGFloat APPLICATION_BODY_FONT_FONT_SIZE;
...
UIKIT_EXTERN NSString *ZIFFY_BASE_URL;
UIKIT_EXTERN NSString *SEARCH_URL_PATH;


UIKIT_EXTERN NSString *SEARCH_LOADING_MESSAGE;
UIKIT_EXTERN NSString *SEARCH_LOADING_PAYLOAD;
